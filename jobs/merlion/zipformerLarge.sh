#!/bin/bash
#$ -N zipformerLarge
#$ -j y -o /export/c09/lavanya/jobs/logs/zinglish/log.zipformerLarge
#$ -M ls1@jh.edu
#$ -m e
...
# Clear the log file
> /export/c09/lavanya/jobs/logs/zinglish/log.zipformerLarge
...
directory="/export/c09/lavanya/languageIdentification/zinglish/large/segmentLarge/"
...
# Log the duration
echo "Job ran for $duration seconds." >> /export/c09/lavanya/jobs/logs/zinglish/log.zipformerLarge
